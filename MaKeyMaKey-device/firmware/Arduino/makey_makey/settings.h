...
int keyCodes[NUM_INPUTS] = {
  ...
  'u',//KEY_UP_ARROW,      // up arrow pad
  'v',//KEY_DOWN_ARROW,    // down arrow pad
  'l',//KEY_LEFT_ARROW,    // left arrow pad
  'r',//KEY_RIGHT_ARROW,   // right arrow pad
  ' ',               // space button pad
  'c', //MOUSE_LEFT,        // click button pad
  ...
  '5',//MOUSE_MOVE_UP,      // pin A5
  '4',//MOUSE_MOVE_DOWN,    // pin A4
  '3',//MOUSE_MOVE_LEFT,    // pin A3
  '2',//MOUSE_MOVE_RIGHT,   // pin A2
  '1',//MOUSE_LEFT,         // pin A1
  '0',//MOUSE_RIGHT         // pin A0
};
